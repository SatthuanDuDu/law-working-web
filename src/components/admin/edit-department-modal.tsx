...
import { updateDepartmentAction } from "@/lib/actions";
...
export type EditDepartmentInitial = {
  id: string;
  name: string;
};
    ...
    confirm({
      ...
      onConfirm: () => {
        ...
        startTransition(async () => {
          const result = await updateDepartmentAction(item.id, formData);
          if (result.error) {
        ...
        >
          ...
          >
            <div className="min-h-0 flex-1 space-y-5 overflow-y-auto px-5 py-5 sm:px-6">
              <OutlinedField label={t("nameLabel")} htmlFor="edit-department-name" className="mt-1">
                <Input
